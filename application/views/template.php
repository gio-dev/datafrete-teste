...
<head>
    ...
    <meta name="description" content="Datafrete">
    ...
    <link rel="stylesheet" href="<?=str_replace("index.php/", "", base_url());?>assets/css/style_geral.css?rand=<?=rand();?>">
...
<body>
  ...
  <script src="<?= str_replace('index.php/', '',base_url()) ?>assets/js/jquery.mask.min.js"></script>
  ...
  <script src="<?=str_replace("index.php/", "", base_url());?>assets/js/scripts.js?rand=<?=rand();?>"></script>
